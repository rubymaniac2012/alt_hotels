...
RSpec.describe '/reservations', type: :request do
  ...
  let(:invalid_attributes) do
    FactoryBot.attributes_for(:reservation).merge(user_id: user.id, room_id: room.id, check_in: Date.today + rand(2..5))
  end
  ...
  describe 'PATCH /update' do
    context 'with valid parameters' do
      ...
      before do
        patch hotel_reservation_url(reservation.hotel, reservation),
              params: { reservation: { check_out: valid_check_out } }
      end
    ...
    context 'with invalid parameters' do
      ...
      before do
        patch hotel_reservation_url(reservation.hotel, reservation),
              params: { reservation: { check_out: invalid_check_out } }
      end
  ...
  describe 'DELETE /destroy' do
    it 'destroys the requested reservation' do
      ...
      end.to change(Reservation.active, :count).by(-1)
    end
